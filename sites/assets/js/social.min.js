(function () {
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostAction.vue";
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostComment.vue";
	...
	__vue_render__$2._withStripped = true;
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostDropdownMenu.vue";
	...
	__vue_render__$3._withStripped = true;
	  ...
	  var __vue_inject_styles__$3 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-2c6655c6_0", { source: ".post-comments[data-v-2c6655c6] {\n  padding: 15px 46px;\n  padding-top: 0px;\n  background: #F6F6F6;\n}\n.indicator[data-v-2c6655c6] {\n  margin-left: 15px;\n}\n.fade-enter-active[data-v-2c6655c6],\n.fade-leave-active[data-v-2c6655c6] {\n  transition: opacity 0.8s;\n}\n.fade-enter[data-v-2c6655c6],\n.fade-leave-to[data-v-2c6655c6] {\n  opacity: 0;\n}\n", map: {"version":3,"sources":["Post.vue"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,mBAAmB;AACrB;AACA;EACE,iBAAiB;AACnB;AACA;;EAEE,wBAAwB;AAC1B;AACA;;EAEE,UAAU;AACZ","file":"Post.vue","sourcesContent":[".post-comments {\n  padding: 15px 46px;\n  padding-top: 0px;\n  background: #F6F6F6;\n}\n.indicator {\n  margin-left: 15px;\n}\n.fade-enter-active,\n.fade-leave-active {\n  transition: opacity 0.8s;\n}\n.fade-enter,\n.fade-leave-to {\n  opacity: 0;\n}\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$3 = "data-v-2c6655c6";
	  /* module identifier */
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/Post.vue";
	...
	__vue_render__$4._withStripped = true;
	  ...
	  var __vue_inject_styles__$4 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-27ccf900_0", { source: "@keyframes load-data-v-27ccf900 {\n0% {\n    background-position: -100px;\n}\n40%,\n  100% {\n    background-position: 500px;\n}\n}\n.post-skeleton[data-v-27ccf900] {\n  height: 250px;\n  border-radius: 4px;\n  max-width: 600px;\n  border: 1px solid #ededed;\n  margin-bottom: 15px;\n}\n.post-skeleton .post-skeleton-body[data-v-27ccf900] {\n  padding: 15px;\n}\n.post-skeleton .post-skeleton-body .user-name[data-v-27ccf900] {\n  height: 10px;\n  width: 100px;\n  margin-left: 5px;\n}\n.post-skeleton .post-skeleton-body .content[data-v-27ccf900] {\n  height: 100px;\n  margin: 15px 0 0 46px;\n}\n.post-skeleton .post-skeleton-body .user-name[data-v-27ccf900],\n.post-skeleton .post-skeleton-body .avatar[data-v-27ccf900],\n.post-skeleton .post-skeleton-body .content[data-v-27ccf900] {\n  background-image: linear-gradient(90deg, #f8f8f8 0px, #fcfcfc 40px, #f8f8f8 80px);\n  background-size: 600px;\n  border-radius: 4px;\n  animation: load-data-v-27ccf900 3s infinite linear;\n}\n.post-skeleton .post-skeleton-foot[data-v-27ccf900] {\n  width: 100%;\n  height: 40px;\n  background: #f8f8f8;\n}\n", map: {"version":3,"sources":["PostSkeleton.vue","/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSkeleton.vue"],"names":[],"mappings":"AAAA;AACE;IACE,2BAA2B;AAC7B;AACA;;IAEE,0BAA0B;AAC5B;AACF;AACA;EACE,aAAa;EACb,kBAAkB;EAClB,gBAAgB;ECClB,yBAAA;EACA,mBAAA;AACA;ADCA;ECCA,aAAA;AACA;AACA;EACA,YAAA;EDCE,YAAY;ECCd,gBAAA;AACA;AACA;EACA,aAAA;EDCE,qBAAqB;ACCvB;AACA;;;EAGA,iFAAA;EACA,sBAAA;EACA,kBAAA;EACA,kDAAA;AACA;AACA;EACA,WAAA;EACA,YAAA;EACA,mBAAA;AACA","file":"PostSkeleton.vue","sourcesContent":["@keyframes load {\n  0% {\n    background-position: -100px;\n  }\n  40%,\n  100% {\n    background-position: 500px;\n  }\n}\n.post-skeleton {\n  height: 250px;\n  border-radius: 4px;\n  max-width: 600px;\n  border: 1px solid #ededed;\n  margin-bottom: 15px;\n}\n.post-skeleton .post-skeleton-body {\n  padding: 15px;\n}\n.post-skeleton .post-skeleton-body .user-name {\n  height: 10px;\n  width: 100px;\n  margin-left: 5px;\n}\n.post-skeleton .post-skeleton-body .content {\n  height: 100px;\n  margin: 15px 0 0 46px;\n}\n.post-skeleton .post-skeleton-body .user-name,\n.post-skeleton .post-skeleton-body .avatar,\n.post-skeleton .post-skeleton-body .content {\n  background-image: linear-gradient(90deg, #f8f8f8 0px, #fcfcfc 40px, #f8f8f8 80px);\n  background-size: 600px;\n  border-radius: 4px;\n  animation: load 3s infinite linear;\n}\n.post-skeleton .post-skeleton-foot {\n  width: 100%;\n  height: 40px;\n  background: #f8f8f8;\n}\n","<template>\n\t<div class=\"post-skeleton flex-column justify-between\">\n\t\t<div class=\"post-skeleton-body\">\n\t\t\t<div class=\"flex\">\n\t\t\t\t<div class=\"avatar avatar-medium\"></div>\n\t\t\t\t<div class=\"user-name\"></div>\n\t\t\t</div>\n\t\t\t<div class=\"content\"></div>\n\t\t</div>\n\t\t<div class=\"post-skeleton-foot\"></div>\n\t</div>\n</template>\n<style lang=\"less\" scoped>\n@base-color: #f8f8f8;\n@shine-color: #fcfcfc;\n@animation-duration: 3s;\n\n@keyframes load {\n\t0% {\n\t\tbackground-position: -100px\n\t}\n\n\t40%, 100% {\n\t\tbackground-position: 500px\n\t}\n}\n\n.background-img() {\n\tbackground-image: linear-gradient(90deg, @base-color 0px, @shine-color 40px, @base-color 80px);\n\tbackground-size: 600px\n}\n.post-skeleton {\n\theight: 250px;\n\tborder-radius: 4px;\n\tmax-width: 600px;\n\tborder: 1px solid #ededed;\n\tmargin-bottom: 15px;\n\t.post-skeleton-body {\n\t\tpadding: 15px;\n\t\t.user-name {\n\t\t\theight: 10px;\n\t\t\twidth: 100px;\n\t\t\tmargin-left: 5px;\n\t\t}\n\t\t.content {\n\t\t\theight: 100px;\n\t\t\tmargin: 15px 0 0 46px;\n\t\t}\n\t\t.user-name, .avatar, .content {\n\t\t\t.background-img();\n\t\t\tborder-radius: 4px;\n\t\t\tanimation: load @animation-duration infinite linear;\n\t\t}\n\t}\n\t.post-skeleton-foot {\n\t\twidth: 100%;\n\t\theight: 40px;\n\t\tbackground: @base-color;\n\t}\n}\n</style>"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$4 = "data-v-27ccf900";
	  /* module identifier */
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSkeleton.vue";
	...
	__vue_render__$5._withStripped = true;
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostLoader.vue";
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSidebar.vue";
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ActivitySidebar.vue";
	...
	__vue_render__$8._withStripped = true;
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/Wall.vue";
	...
	__vue_render__$9._withStripped = true;
	  ...
	  var __vue_inject_styles__$9 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-bca73b22_0", { source: ".profile-sidebar[data-v-bca73b22] {\n  padding: 10px 10px 0 0;\n}\n.user-details[data-v-bca73b22] {\n  min-height: 150px;\n}\n.user-details .location[data-v-bca73b22],\n.user-details .interest[data-v-bca73b22] {\n  margin-bottom: 10px;\n}\n.user-details .location i[data-v-bca73b22],\n.user-details .interest i[data-v-bca73b22] {\n  width: 15px;\n}\n.edit-profile-link[data-v-bca73b22] {\n  margin-top: 15px;\n}\n", map: {"version":3,"sources":["ProfileSidebar.vue"],"names":[],"mappings":"AAAA;EACE,sBAAsB;AACxB;AACA;EACE,iBAAiB;AACnB;AACA;;EAEE,mBAAmB;AACrB;AACA;;EAEE,WAAW;AACb;AACA;EACE,gBAAgB;AAClB","file":"ProfileSidebar.vue","sourcesContent":[".profile-sidebar {\n  padding: 10px 10px 0 0;\n}\n.user-details {\n  min-height: 150px;\n}\n.user-details .location,\n.user-details .interest {\n  margin-bottom: 10px;\n}\n.user-details .location i,\n.user-details .interest i {\n  width: 15px;\n}\n.edit-profile-link {\n  margin-top: 15px;\n}\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$9 = "data-v-bca73b22";
	  /* module identifier */
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ProfileSidebar.vue";
	...
	__vue_render__$a._withStripped = true;
	  ...
	  function __vue_normalize__$a(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ProfileBanner.vue";
	...
	__vue_render__$b._withStripped = true;
	  ...
	  function __vue_normalize__$b(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/Profile.vue";
	...
	__vue_render__$c._withStripped = true;
	  ...
	  var __vue_inject_styles__$c = function (inject) {
	    if (!inject) { return }
	    inject("data-v-78b73c70_0", { source: "/* palette colors*/\n/* the element that this class is applied to, should have a max width for this to work*/\nbody[data-v-78b73c70] {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", \"Roboto\", \"Oxygen\", \"Ubuntu\", \"Cantarell\", \"Fira Sans\", \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n}\na[data-v-78b73c70] {\n  cursor: pointer;\n}\na[data-v-78b73c70],\na[data-v-78b73c70]:hover,\na[data-v-78b73c70]:active,\na[data-v-78b73c70]:focus,\n.btn[data-v-78b73c70],\n.btn[data-v-78b73c70]:hover,\n.btn[data-v-78b73c70]:active,\n.btn[data-v-78b73c70]:focus {\n  outline: 0;\n}\nimg[data-v-78b73c70] {\n  max-width: 100%;\n}\np[data-v-78b73c70] {\n  margin: 10px 0;\n}\n.text-color[data-v-78b73c70] {\n  color: #36414c !important;\n}\n.text-muted[data-v-78b73c70] {\n  color: #8D99A6 !important;\n}\n.text-extra-muted[data-v-78b73c70] {\n  color: #d1d8dd !important;\n}\na[data-v-78b73c70],\n.badge[data-v-78b73c70] {\n  -webkit-transition: 0.2s;\n  -o-transition: 0.2s;\n  transition: 0.2s;\n}\n.btn[data-v-78b73c70] {\n  -webkit-transition: background-color 0.2s;\n  -o-transition: background-color 0.2s;\n  transition: background-color 0.2s;\n}\na.disabled[data-v-78b73c70],\na.disabled[data-v-78b73c70]:hover {\n  color: #888;\n  cursor: default;\n  text-decoration: none;\n}\na.grey[data-v-78b73c70],\n.sidebar-section a[data-v-78b73c70],\n.control-value a[data-v-78b73c70],\n.data-row a[data-v-78b73c70] {\n  text-decoration: none;\n}\na.grey[data-v-78b73c70]:hover,\n.sidebar-section a[data-v-78b73c70]:hover,\n.control-value a[data-v-78b73c70]:hover,\n.data-row a[data-v-78b73c70]:hover,\na.grey[data-v-78b73c70]:focus,\n.sidebar-section a[data-v-78b73c70]:focus,\n.control-value a[data-v-78b73c70]:focus,\n.data-row a[data-v-78b73c70]:focus {\n  text-decoration: underline;\n}\na.text-muted[data-v-78b73c70],\na.text-extra-muted[data-v-78b73c70] {\n  text-decoration: none;\n}\n.underline[data-v-78b73c70] {\n  text-decoration: underline;\n}\n.inline-block[data-v-78b73c70] {\n  display: inline-block;\n}\n.bold[data-v-78b73c70],\n.strong[data-v-78b73c70] {\n  font-weight: bold;\n}\nkbd[data-v-78b73c70] {\n  color: inherit;\n  background-color: #f0f4f7;\n}\n.btn [class^=\"fa fa-\"][data-v-78b73c70],\n.nav [class^=\"fa fa-\"][data-v-78b73c70],\n.btn [class*=\"fa fa-\"][data-v-78b73c70],\n.nav [class*=\"fa fa-\"][data-v-78b73c70] {\n  display: inline-block;\n}\n/* dropdowns */\n.dropdown-backdrop[data-v-78b73c70] {\n  display: none;\n}\n.dropdown-menu > li > a[data-v-78b73c70] {\n  padding: 14px;\n  white-space: normal;\n}\n.dropdown-menu[data-v-78b73c70] {\n  min-width: 200px;\n  padding: 0px;\n  font-size: 12px;\n  max-height: 500px;\n  overflow: auto;\n  border-radius: 0px 0px 4px 4px;\n}\n.dropdown-menu .dropdown-header[data-v-78b73c70] {\n  padding: 3px 14px;\n  font-size: 11px;\n  font-weight: 200;\n  padding-top: 12px;\n}\n.dropdown-menu .divider[data-v-78b73c70] {\n  margin: 0px;\n}\na.badge-hover:hover .badge[data-v-78b73c70],\na.badge-hover:focus .badge[data-v-78b73c70],\na.badge-hover:active .badge[data-v-78b73c70] {\n  background-color: #d8dfe5;\n}\n.msgprint-dialog[data-v-78b73c70] {\n  max-width: 400px;\n}\n.msgprint-dialog .modal-content[data-v-78b73c70] {\n  min-height: 110px;\n}\n.msgprint-scroll[data-v-78b73c70] {\n  max-height: 36em;\n  overflow: scroll;\n}\n.msgprint[data-v-78b73c70] {\n  word-wrap: break-word;\n}\n.msgprint pre[data-v-78b73c70] {\n  text-align: left;\n}\n.msgprint a[data-v-78b73c70]:not(.btn) {\n  text-decoration: underline;\n}\n.centered[data-v-78b73c70] {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n.border-top[data-v-78b73c70] {\n  border-top: 1px solid #d1d8dd;\n}\n.border-bottom[data-v-78b73c70] {\n  border-bottom: 1px solid #d1d8dd;\n}\n.border-left[data-v-78b73c70] {\n  border-left: 1px solid #d1d8dd;\n}\n.border-right[data-v-78b73c70] {\n  border-right: 1px solid #d1d8dd;\n}\n.border[data-v-78b73c70] {\n  border: 1px solid #d1d8dd;\n}\n.rounded[data-v-78b73c70] {\n  border-radius: 4px;\n}\n.close-inline[data-v-78b73c70] {\n  font-size: 120%;\n  font-weight: bold;\n  line-height: 1;\n  cursor: pointer;\n  color: inherit;\n  display: inline-block;\n}\n.close-inline[data-v-78b73c70]:hover,\n.close-inline[data-v-78b73c70]:focus {\n  text-decoration: none;\n}\n.middle[data-v-78b73c70] {\n  vertical-align: middle;\n}\n.full-center-container[data-v-78b73c70] {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n.full-center[data-v-78b73c70] {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 100%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n#freeze[data-v-78b73c70] {\n  z-index: 1020;\n  bottom: 0;\n  opacity: 0;\n  background-color: #fafbfc;\n}\n#freeze .freeze-message-container[data-v-78b73c70] {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n#freeze .freeze-message[data-v-78b73c70] {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 100%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n  text-align: center;\n  color: #36414c !important;\n}\n#freeze.dark[data-v-78b73c70] {\n  background-color: #334143;\n}\n#freeze.in[data-v-78b73c70] {\n  opacity: 0.5;\n}\na.no-decoration[data-v-78b73c70] {\n  text-decoration: none;\n  color: inherit;\n}\na.no-decoration[data-v-78b73c70]:hover,\na.no-decoration[data-v-78b73c70]:focus,\na.no-decoration[data-v-78b73c70]:active {\n  text-decoration: none;\n  color: inherit;\n}\n.padding[data-v-78b73c70] {\n  padding: 15px;\n}\n.margin[data-v-78b73c70] {\n  margin: 15px;\n}\n.margin-top[data-v-78b73c70] {\n  margin-top: 15px;\n}\n.margin-bottom[data-v-78b73c70] {\n  margin-bottom: 15px;\n}\n.margin-left[data-v-78b73c70] {\n  margin-left: 15px;\n}\n.margin-right[data-v-78b73c70] {\n  margin-right: 15px;\n}\n@media (max-width: 767px) {\n.text-center-xs[data-v-78b73c70] {\n    text-align: center;\n}\n}\n.grayscale[data-v-78b73c70] {\n  -webkit-filter: grayscale(100%);\n  filter: grayscale(100%);\n}\n.uppercase[data-v-78b73c70] {\n  padding-bottom: 4px;\n  text-transform: uppercase;\n  font-size: 12px;\n  letter-spacing: 0.4px;\n  color: #8d99a6;\n}\n.ellipsis[data-v-78b73c70] {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  max-width: 100%;\n  vertical-align: middle;\n}\n/* Given that the element that text-ellipsis is applied to,\n\tshould have a max width for it to work */\n.ellipsis-width[data-v-78b73c70] {\n  max-width: 200px;\n}\n/* Font size utilities */\n.text-regular[data-v-78b73c70] {\n  font-size: 14px;\n}\n.text-medium[data-v-78b73c70] {\n  font-size: 12px;\n}\n.text-small[data-v-78b73c70] {\n  font-size: 10px;\n}\n.text-large[data-v-78b73c70] {\n  font-size: 16px;\n}\n.disable-click[data-v-78b73c70] {\n  pointer-events: none;\n}\n.popover-title[data-v-78b73c70] {\n  display: none;\n}\n.user-list[data-v-78b73c70] {\n  border-left: 1px solid #d1d8dd;\n  border-right: 1px solid #d1d8dd;\n}\n.user-list .user-card[data-v-78b73c70] {\n  display: flex;\n  cursor: pointer;\n  padding: 12px 15px;\n  border-bottom: 1px solid #d1d8dd;\n}\n.user-list .user-card .user-details[data-v-78b73c70] {\n  flex: 1;\n}\n.user-list .user-card .user-details .italic[data-v-78b73c70] {\n  font-style: italic;\n}\n.rank-column[data-v-78b73c70] {\n  flex: 0 0 30px;\n  align-self: center;\n  color: #8D99A6 !important;\n}\n.flex-20[data-v-78b73c70] {\n  flex: 0 0 20%;\n  text-align: right;\n  align-self: center;\n}\n.flex-40[data-v-78b73c70] {\n  flex: 0 0 40%;\n}\n.user-list-header[data-v-78b73c70] {\n  background-color: #fafbfc;\n}\n.search-bar[data-v-78b73c70] {\n  position: sticky;\n  top: 0;\n  background: white;\n  height: 75px;\n  text-align: center;\n  width: 100%;\n  left: 0;\n}\n.search-bar div[data-v-78b73c70] {\n  margin: auto;\n}\n.energy-point-history[data-v-78b73c70] {\n  border-bottom: 1px solid #d1d8dd;\n  background-color: #fafbfc;\n}\n", map: {"version":3,"sources":["UserList.vue","/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/UserList.vue"],"names":[],"mappings":"AAAA,kBAAkB;AAClB,uFAAuF;AACvF;EACE,8JAA8J;AAChK;AACA;EACE,eAAe;AACjB;AACA;;;;;;;;EAQE,UAAU;AACZ;AACA;EACE,eAAe;AACjB;AACA;EACE,cAAc;AAChB;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,yBAAyB;AAC3B;AACA;;EAEE,wBAAwB;EACxB,mBAAmB;EACnB,gBAAgB;AAClB;AACA;EACE,yCAAyC;EACzC,oCAAoC;EACpC,iCAAiC;AACnC;AACA;;EAEE,WAAW;EACX,eAAe;EACf,qBAAqB;AACvB;AACA;;;;EAIE,qBAAqB;AACvB;AACA;;;;;;;;EAQE,0BAA0B;AAC5B;AACA;;EAEE,qBAAqB;AACvB;AACA;EACE,0BAA0B;AAC5B;AACA;EACE,qBAAqB;AACvB;AACA;;EAEE,iBAAiB;AACnB;AACA;EACE,cAAc;EACd,yBAAyB;AAC3B;AACA;;;;EAIE,qBAAqB;AACvB;AACA,cAAc;AACd;EACE,aAAa;AACf;AACA;EACE,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,iBAAiB;EACjB,cAAc;EACd,8BAA8B;AAChC;AACA;EACE,iBAAiB;EACjB,eAAe;EACf,gBAAgB;EAChB,iBAAiB;AACnB;AACA;EACE,WAAW;AACb;AACA;;;EAGE,yBAAyB;AAC3B;AACA;EACE,gBAAgB;AAClB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,gBAAgB;EAChB,gBAAgB;AAClB;AACA;EACE,qBAAqB;AACvB;AACA;EACE,gBAAgB;AAClB;AACA;EACE,0BAA0B;AAC5B;AACA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,wCAAwC;AAC1C;AACA;EACE,6BAA6B;AAC/B;AACA;EACE,gCAAgC;AAClC;AACA;EACE,8BAA8B;AAChC;AACA;EACE,+BAA+B;AACjC;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,kBAAkB;AACpB;AACA;EACE,eAAe;ECCjB,iBAAA;EACA,cAAA;EACA,eAAA;EACA,cAAA;EACA,qBAAA;AACA;AACA;;EAEA,qBAAA;AACA;AACA;EACA,sBAAA;AACA;AACA;EACA,kBAAA;EACA,MAAA;EACA,SAAA;EACA,OAAA;EACA,QAAA;AACA;AACA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,WAAA;EACA,gCAAA;EACA,wCAAA;AACA;AACA;EACA,aAAA;EACA,SAAA;EACA,UAAA;EACA,yBAAA;AACA;AACA;EACA,kBAAA;EACA,MAAA;EACA,SAAA;EACA,OAAA;EACA,QAAA;AACA;AACA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,WAAA;EACA,gCAAA;EACA,wCAAA;EACA,kBAAA;EDCE,yBAAyB;AAC3B;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,YAAY;AACd;AACA;EACE,qBAAqB;EACrB,cAAc;AAChB;AACA;;;EAGE,qBAAqB;EACrB,cAAc;AAChB;AACA;EACE,aAAa;AACf;AACA;EACE,YAAY;AACd;AACA;EACE,gBAAgB;AAClB;AACA;EACE,mBAAmB;AACrB;AACA;EACE,iBAAiB;AACnB;AACA;EACE,kBAAkB;AACpB;AACA;AACE;IACE,kBAAkB;AACpB;AACF;AACA;EACE,+BAA+B;EAC/B,uBAAuB;AACzB;AACA;EACE,mBAAmB;EACnB,yBAAyB;EACzB,eAAe;EACf,qBAAqB;EACrB,cAAc;AAChB;AACA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;EACvB,eAAe;EACf,sBAAsB;AACxB;AACA;yCACyC;AACzC;EACE,gBAAgB;AAClB;AACA,wBAAwB;AACxB;EACE,eAAe;AACjB;AACA;EACE,eAAe;AACjB;AACA;EACE,eAAe;AACjB;AACA;EACE,eAAe;AACjB;AACA;EACE,oBAAoB;AACtB;AACA;EACE,aAAa;AACf;AACA;EACE,8BAA8B;EAC9B,+BAA+B;AACjC;AACA;EACE,aAAa;EACb,eAAe;EACf,kBAAkB;EAClB,gCAAgC;AAClC;AACA;EACE,OAAO;AACT;AACA;EACE,kBAAkB;AACpB;AACA;EACE,cAAc;EACd,kBAAkB;EAClB,yBAAyB;AAC3B;AACA;EACE,aAAa;EACb,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,aAAa;AACf;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,gBAAgB;EAChB,MAAM;EACN,iBAAiB;EACjB,YAAY;EACZ,kBAAkB;EAClB,WAAW;EACX,OAAO;AACT;AACA;EACE,YAAY;AACd;AACA;EACE,gCAAgC;EAChC,yBAAyB;AAC3B","file":"UserList.vue","sourcesContent":["/* palette colors*/\n/* the element that this class is applied to, should have a max width for this to work*/\nbody {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", \"Roboto\", \"Oxygen\", \"Ubuntu\", \"Cantarell\", \"Fira Sans\", \"Droid Sans\", \"Helvetica Neue\", sans-serif;\n}\na {\n  cursor: pointer;\n}\na,\na:hover,\na:active,\na:focus,\n.btn,\n.btn:hover,\n.btn:active,\n.btn:focus {\n  outline: 0;\n}\nimg {\n  max-width: 100%;\n}\np {\n  margin: 10px 0;\n}\n.text-color {\n  color: #36414c !important;\n}\n.text-muted {\n  color: #8D99A6 !important;\n}\n.text-extra-muted {\n  color: #d1d8dd !important;\n}\na,\n.badge {\n  -webkit-transition: 0.2s;\n  -o-transition: 0.2s;\n  transition: 0.2s;\n}\n.btn {\n  -webkit-transition: background-color 0.2s;\n  -o-transition: background-color 0.2s;\n  transition: background-color 0.2s;\n}\na.disabled,\na.disabled:hover {\n  color: #888;\n  cursor: default;\n  text-decoration: none;\n}\na.grey,\n.sidebar-section a,\n.control-value a,\n.data-row a {\n  text-decoration: none;\n}\na.grey:hover,\n.sidebar-section a:hover,\n.control-value a:hover,\n.data-row a:hover,\na.grey:focus,\n.sidebar-section a:focus,\n.control-value a:focus,\n.data-row a:focus {\n  text-decoration: underline;\n}\na.text-muted,\na.text-extra-muted {\n  text-decoration: none;\n}\n.underline {\n  text-decoration: underline;\n}\n.inline-block {\n  display: inline-block;\n}\n.bold,\n.strong {\n  font-weight: bold;\n}\nkbd {\n  color: inherit;\n  background-color: #f0f4f7;\n}\n.btn [class^=\"fa fa-\"],\n.nav [class^=\"fa fa-\"],\n.btn [class*=\"fa fa-\"],\n.nav [class*=\"fa fa-\"] {\n  display: inline-block;\n}\n/* dropdowns */\n.dropdown-backdrop {\n  display: none;\n}\n.dropdown-menu > li > a {\n  padding: 14px;\n  white-space: normal;\n}\n.dropdown-menu {\n  min-width: 200px;\n  padding: 0px;\n  font-size: 12px;\n  max-height: 500px;\n  overflow: auto;\n  border-radius: 0px 0px 4px 4px;\n}\n.dropdown-menu .dropdown-header {\n  padding: 3px 14px;\n  font-size: 11px;\n  font-weight: 200;\n  padding-top: 12px;\n}\n.dropdown-menu .divider {\n  margin: 0px;\n}\na.badge-hover:hover .badge,\na.badge-hover:focus .badge,\na.badge-hover:active .badge {\n  background-color: #d8dfe5;\n}\n.msgprint-dialog {\n  max-width: 400px;\n}\n.msgprint-dialog .modal-content {\n  min-height: 110px;\n}\n.msgprint-scroll {\n  max-height: 36em;\n  overflow: scroll;\n}\n.msgprint {\n  word-wrap: break-word;\n}\n.msgprint pre {\n  text-align: left;\n}\n.msgprint a:not(.btn) {\n  text-decoration: underline;\n}\n.centered {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n.border-top {\n  border-top: 1px solid #d1d8dd;\n}\n.border-bottom {\n  border-bottom: 1px solid #d1d8dd;\n}\n.border-left {\n  border-left: 1px solid #d1d8dd;\n}\n.border-right {\n  border-right: 1px solid #d1d8dd;\n}\n.border {\n  border: 1px solid #d1d8dd;\n}\n.rounded {\n  border-radius: 4px;\n}\n.close-inline {\n  font-size: 120%;\n  font-weight: bold;\n  line-height: 1;\n  cursor: pointer;\n  color: inherit;\n  display: inline-block;\n}\n.close-inline:hover,\n.close-inline:focus {\n  text-decoration: none;\n}\n.middle {\n  vertical-align: middle;\n}\n.full-center-container {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n.full-center {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 100%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n}\n#freeze {\n  z-index: 1020;\n  bottom: 0;\n  opacity: 0;\n  background-color: #fafbfc;\n}\n#freeze .freeze-message-container {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n#freeze .freeze-message {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 100%;\n  transform: translate(-50%, -50%);\n  -webkit-transform: translate(-50%, -50%);\n  text-align: center;\n  color: #36414c !important;\n}\n#freeze.dark {\n  background-color: #334143;\n}\n#freeze.in {\n  opacity: 0.5;\n}\na.no-decoration {\n  text-decoration: none;\n  color: inherit;\n}\na.no-decoration:hover,\na.no-decoration:focus,\na.no-decoration:active {\n  text-decoration: none;\n  color: inherit;\n}\n.padding {\n  padding: 15px;\n}\n.margin {\n  margin: 15px;\n}\n.margin-top {\n  margin-top: 15px;\n}\n.margin-bottom {\n  margin-bottom: 15px;\n}\n.margin-left {\n  margin-left: 15px;\n}\n.margin-right {\n  margin-right: 15px;\n}\n@media (max-width: 767px) {\n  .text-center-xs {\n    text-align: center;\n  }\n}\n.grayscale {\n  -webkit-filter: grayscale(100%);\n  filter: grayscale(100%);\n}\n.uppercase {\n  padding-bottom: 4px;\n  text-transform: uppercase;\n  font-size: 12px;\n  letter-spacing: 0.4px;\n  color: #8d99a6;\n}\n.ellipsis {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  max-width: 100%;\n  vertical-align: middle;\n}\n/* Given that the element that text-ellipsis is applied to,\n\tshould have a max width for it to work */\n.ellipsis-width {\n  max-width: 200px;\n}\n/* Font size utilities */\n.text-regular {\n  font-size: 14px;\n}\n.text-medium {\n  font-size: 12px;\n}\n.text-small {\n  font-size: 10px;\n}\n.text-large {\n  font-size: 16px;\n}\n.disable-click {\n  pointer-events: none;\n}\n.popover-title {\n  display: none;\n}\n.user-list {\n  border-left: 1px solid #d1d8dd;\n  border-right: 1px solid #d1d8dd;\n}\n.user-list .user-card {\n  display: flex;\n  cursor: pointer;\n  padding: 12px 15px;\n  border-bottom: 1px solid #d1d8dd;\n}\n.user-list .user-card .user-details {\n  flex: 1;\n}\n.user-list .user-card .user-details .italic {\n  font-style: italic;\n}\n.rank-column {\n  flex: 0 0 30px;\n  align-self: center;\n  color: #8D99A6 !important;\n}\n.flex-20 {\n  flex: 0 0 20%;\n  text-align: right;\n  align-self: center;\n}\n.flex-40 {\n  flex: 0 0 40%;\n}\n.user-list-header {\n  background-color: #fafbfc;\n}\n.search-bar {\n  position: sticky;\n  top: 0;\n  background: white;\n  height: 75px;\n  text-align: center;\n  width: 100%;\n  left: 0;\n}\n.search-bar div {\n  margin: auto;\n}\n.energy-point-history {\n  border-bottom: 1px solid #d1d8dd;\n  background-color: #fafbfc;\n}\n","<template>\n\t<div class=\"user-list-container\">\n\t\t<ul class=\"list-unstyled user-list\">\n\t\t\t<li class=\"user-card user-list-header text-medium\">\n\t\t\t\t<span class=\"rank-column\"></span>\n\t\t\t\t<span class=\"user-details text-muted\">\n\t\t\t\t\t<input\n\t\t\t\t\t\tclass=\"form-control\"\n\t\t\t\t\t\ttype=\"search\"\n\t\t\t\t\t\tplaceholder=\"Search User\"\n\t\t\t\t\t\tv-model=\"filter_users_by\"\n\t\t\t\t\t>\n\t\t\t\t</span>\n\t\t\t\t<span class=\"flex-40\"></span>\n\t\t\t\t<span class=\"flex-20 text-muted\">\n\t\t\t\t\t<select class=\"form-control\" data-toggle=\"tooltip\" title=\"Period\" v-model=\"period\">\n\t\t\t\t\t\t<option v-for=\"value in period_options\" :key=\"value\" :value=\"value\">{{ value }}</option>\n\t\t\t\t\t</select>\n\t\t\t\t</span>\n\t\t\t</li>\n\t\t\t<li class=\"user-card user-list-header text-medium\">\n\t\t\t\t<span class=\"rank-column\">#</span>\n\t\t\t\t<span class=\"user-details text-muted\">{{ __('User') }}</span>\n\t\t\t\t<span\n\t\t\t\t\tclass=\"flex-20 text-muted\"\n\t\t\t\t\tv-for=\"title in ['Energy Points', 'Review Points', 'Points Given']\"\n\t\t\t\t\t:key=\"title\"\n\t\t\t\t>{{ __(title) }}</span>\n\t\t\t</li>\n\t\t\t<li v-for=\"(user, index) in filtered_users\" :key=\"user.name\">\n\t\t\t\t<div class=\"user-card\">\n\t\t\t\t\t<span class=\"user-details flex\" @click=\"go_to_profile_page(user.name)\">\n\t\t\t\t\t\t<span class=\"rank-column\">{{ index + 1 }}</span>\n\t\t\t\t\t\t<span v-html=\"get_avatar(user.name)\"></span>\n\t\t\t\t\t\t<span>\n\t\t\t\t\t\t\t{{ user.fullname }}\n\t\t\t\t\t\t\t<div\n\t\t\t\t\t\t\t\tclass=\"text-muted text-medium\"\n\t\t\t\t\t\t\t\t:class=\"{'italic': !user.bio}\"\n\t\t\t\t\t\t\t>{{ frappe.ellipsis(user.bio, 100) || 'No Bio'}}</div>\n\t\t\t\t\t\t</span>\n\t\t\t\t\t</span>\n\t\t\t\t\t<span\n\t\t\t\t\t\tclass=\"text-muted text-nowrap flex-20\"\n\t\t\t\t\t\tv-for=\"key in ['energy_points', 'review_points', 'given_points']\"\n\t\t\t\t\t\t:key=\"key\"\n\t\t\t\t\t\t@click=\"toggle_log(user.name)\"\n\t\t\t\t\t>{{ user[key] }}</span>\n\t\t\t\t</div>\n\t\t\t</li>\n\t\t\t<li class=\"user-card text-muted\" v-if=\"!filtered_users.length\">{{__('No user found')}}</li>\n\t\t</ul>\n\t</div>\n</template>\n<script>\nexport default {\n\tdata() {\n\t\treturn {\n\t\t\tusers: [],\n\t\t\tfilter_users_by: null,\n\t\t\tsort_users_by: 'energy_points',\n\t\t\tsort_order: 'desc',\n\t\t\tshow_log_for: null,\n\t\t\tperiod_options: ['Lifetime', 'This Month', 'This Week', 'Today'],\n\t\t\tperiod: 'This Month'\n\t\t};\n\t},\n\tcomputed: {\n\t\tfrom_date() {\n\t\t\tif (this.period === 'This Month') {\n\t\t\t\treturn frappe.datetime.month_start();\n\t\t\t}\n\t\t\tif (this.period === 'This Week') {\n\t\t\t\treturn frappe.datetime.week_start();\n\t\t\t}\n\t\t\tif (this.period === 'Today') {\n\t\t\t\treturn frappe.datetime.get_today();\n\t\t\t}\n\t\t\treturn null;\n\t\t},\n\t\tfiltered_users() {\n\t\t\tlet filtered = this.users.slice();\n\t\t\tif (this.filter_users_by) {\n\t\t\t\tfiltered = filtered.filter(user =>\n\t\t\t\t\tuser.fullname\n\t\t\t\t\t\t.toLowerCase()\n\t\t\t\t\t\t.includes(this.filter_users_by.toLowerCase())\n\t\t\t\t);\n\t\t\t}\n\n\t\t\tif (this.sort_users_by) {\n\t\t\t\tfiltered.sort((a, b) => {\n\t\t\t\t\tconst value_a = a[this.sort_users_by];\n\t\t\t\t\tconst value_b = b[this.sort_users_by];\n\n\t\t\t\t\tlet return_value = 0;\n\t\t\t\t\tif (value_a > value_b) {\n\t\t\t\t\t\treturn_value = 1;\n\t\t\t\t\t}\n\n\t\t\t\t\tif (value_a < value_b) {\n\t\t\t\t\t\treturn_value = -1;\n\t\t\t\t\t}\n\n\t\t\t\t\tif (this.sort_order === 'desc') {\n\t\t\t\t\t\treturn_value = -return_value;\n\t\t\t\t\t}\n\n\t\t\t\t\treturn return_value;\n\t\t\t\t});\n\t\t\t}\n\t\t\treturn filtered;\n\t\t}\n\t},\n\twatch: {\n\t\tperiod() {\n\t\t\tthis.fetch_users_energy_points_and_update_users();\n\t\t}\n\t},\n\tmounted() {\n\t\t$('[data-toggle=\"tooltip\"]').tooltip();\n\t},\n\tcreated() {\n\t\tconst standard_users = ['Administrator', 'Guest', 'guest@example.com'];\n\t\tthis.users = frappe.boot.user_info;\n\t\t// delete standard users from the list\n\t\tstandard_users.forEach(user => delete this.users[user]);\n\t\tthis.users = Object.values(this.users);\n\t\tthis.fetch_users_energy_points_and_update_users();\n\t\tfrappe.realtime.on('update_points', () => {\n\t\t\tthis.fetch_users_energy_points_and_update_users();\n\t\t});\n\t},\n\tmethods: {\n\t\tget_avatar(user) {\n\t\t\treturn frappe.avatar(user, 'avatar-medium');\n\t\t},\n\t\tgo_to_profile_page(user) {\n\t\t\tfrappe.set_route('social', 'profile', user);\n\t\t},\n\t\tfetch_users_energy_points_and_update_users() {\n\t\t\tfrappe\n\t\t\t\t.xcall(\n\t\t\t\t\t'frappe.social.doctype.energy_point_log.energy_point_log.get_user_energy_and_review_points',\n\t\t\t\t\t{\n\t\t\t\t\t\tfrom_date: this.from_date\n\t\t\t\t\t}\n\t\t\t\t)\n\t\t\t\t.then(data => {\n\t\t\t\t\tlet users = this.users.slice();\n\t\t\t\t\tthis.users = users.map(user => {\n\t\t\t\t\t\tconst points = data[user.name] || {};\n\t\t\t\t\t\tuser.energy_points = points.energy_points || 0;\n\t\t\t\t\t\tuser.review_points = points.review_points || 0;\n\t\t\t\t\t\tuser.given_points = points.given_points || 0;\n\t\t\t\t\t\treturn user;\n\t\t\t\t\t});\n\t\t\t\t});\n\t\t},\n\t\ttoggle_log(user) {\n\t\t\tfrappe.set_route('List', 'Energy Point Log', {user:user});\n\t\t}\n\t}\n};\n</script>\n<style lang=\"less\" scoped>\n@import 'frappe/public/less/common';\n.user-list {\n\tborder-left: 1px solid @border-color;\n\tborder-right: 1px solid @border-color;\n\t.user-card {\n\t\tdisplay: flex;\n\t\tcursor: pointer;\n\t\tpadding: 12px 15px;\n\t\tborder-bottom: 1px solid @border-color;\n\t\t.user-details {\n\t\t\tflex: 1;\n\t\t\t.italic {\n\t\t\t\tfont-style: italic;\n\t\t\t}\n\t\t}\n\t}\n}\n.rank-column {\n\tflex: 0 0 30px;\n\talign-self: center;\n\t.text-muted\n}\n.flex-20 {\n\tflex: 0 0 20%;\n\ttext-align: right;\n\talign-self: center;\n}\n.flex-40 {\n\tflex: 0 0 40%;\n}\n.user-list-header {\n\tbackground-color: @light-bg;\n}\n.search-bar {\n\tposition: sticky;\n\ttop: 0;\n\tbackground: white;\n\theight: 75px;\n\ttext-align: center;\n\tdiv {\n\t\tmargin: auto;\n\t}\n\twidth: 100%;\n\tleft: 0;\n}\n.energy-point-history {\n\tborder-bottom: 1px solid @border-color;\n\tbackground-color: @light-bg;\n}\n</style>\n\n\n\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$c = "data-v-78b73c70";
	  /* module identifier */
	  ...
	  function __vue_normalize__$c(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/UserList.vue";
	...
	__vue_render__$d._withStripped = true;
	  ...
	  function __vue_normalize__$d(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/NotFound.vue";
	...
	__vue_render__$e._withStripped = true;
	  ...
	  function __vue_normalize__$e(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ImageViewer.vue";
	...
	__vue_render__$f._withStripped = true;
	  ...
	  function __vue_normalize__$f(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/social/Home.vue";
