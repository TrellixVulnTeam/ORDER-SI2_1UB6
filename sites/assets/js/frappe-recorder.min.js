(function () {
	...
	var vueRouter = createCommonjsModule(function (module, exports) {
	/**
	  * vue-router v2.8.1
	  * (c) 2017 Evan You
	  * @license MIT
	...
	var VueRouter = unwrapExports(vueRouter);
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/recorder/RecorderRoot.vue";
	  ...
	  var RecorderRoot = __vue_normalize__(
	...
	var script$1 = {
		...
		mounted: function mounted() {
			...
			this.fetch_status();
			this.refresh();
			this.$root.page.set_secondary_action("Clear", function () {
		...
		computed: {
			pages: function() {
				var current_page = this.query.pagination.page;
				var total_pages = this.query.pagination.total;
				return [{
					label: "First",
					number: 1,
		...
		methods: {
			filtered: function(requests) {
				...
				var filters = Object.entries(this.query.filters);
				requests = requests.filter(
					function (r) { return filters.map(function (f) { return (r[f[0]] || "").match(f[1]); }).every(Boolean); }
				);
			...
			paginated: function(requests) {
				requests = requests.slice();
				var begin = (this.query.pagination.page - 1) * (this.query.pagination.limit);
				var end = begin + this.query.pagination.limit;
				return requests.slice(begin, end);
			},
			sorted: function(requests) {
				requests = requests.slice();
				var order = (this.query.order == "asc") ? 1 : -1;
				var sort = this.query.sort;
				return requests.sort(function (a,b) { return (a[sort] > b[sort]) ? order : -order; });
			},
			refresh: function() {
				var this$1 = this;

				frappe.call("frappe.recorder.get").then( function (r) { return this$1.requests = r.message; });
			},
			...
			clear: function() {
				...
				frappe.call("frappe.recorder.delete").then(function (r) { return this$1.refresh(); });
			},
			start: function() {
				var this$1 = this;

				frappe.call("frappe.recorder.start").then(function (r) { return this$1.fetch_status(); });
			},
			stop: function() {
				var this$1 = this;

				frappe.call("frappe.recorder.stop").then(function (r) { return this$1.fetch_status(); });
			},
			fetch_status: function() {
				var this$1 = this;

				frappe.call("frappe.recorder.status").then(function (r) { return this$1.update_status(r.message); });
			},
			...
			update_buttons: function() {
				...
				if(this.status.status == "Active") {
					this.$root.page.set_primary_action("Stop", function () {
						this$1.stop();
					});
				} else {
					this.$root.page.set_primary_action("Start", function () {
						this$1.start();
					});
				}
			},
			route_to_request_detail: function route_to_request_detail(id) {
	    ...
	    _c("div", { staticClass: "frappe-list" }, [
	      ...
	      _vm.requests.length != 0
	        ? _c("div", { staticClass: "result" }, [
	            _c("div", { staticClass: "list-headers" }, [
	              _c(
	                ...
	                [
	                  _c(
	                    "div",
	                    { staticClass: "level-left list-header-subject" },
	                    [
	                      _c(
	                        "div",
	                        {
	                  ...
	                  _c("div", { staticClass: "level-right" }, [
	                    _c("span", { staticClass: "list-count" }, [
	                      _c("span", [
	                        _vm._v(
	                          _vm._s(
	                            (_vm.query.pagination.page - 1) *
	                              _vm.query.pagination.limit +
	                              1
	                          ) +
	                            " - " +
	                            _vm._s(
	                              Math.min(
	                                _vm.query.pagination.page *
	                                  _vm.query.pagination.limit,
	                                _vm.requests.length
	                              )
	                            ) +
	            ...
	            _c(
	              ...
	              _vm._l(
	                _vm.paginated(_vm.sorted(_vm.filtered(_vm.requests))),
	                function(request, index) {
	                  return _c(
	                    "div",
	                    {
	                      ...
	                      on: {
	                        click: function($event) {
	                          return _vm.route_to_request_detail(request.uuid)
	                        }
	                      }
	                    },
	                    [
	                      _c("div", { staticClass: "level list-row small" }, [
	                        _c(
	                          ...
	                          [
	                            ...
	                            _vm._v(" "),
	                            _vm._l(_vm.columns.slice(1), function(
	                              column,
	                              index
	                            ) {
	                              return _c(
	                                ...
	                                [
	                                  _c(
	                                    ...
	                                    [_vm._v(_vm._s(request[column.slug]))]
	                                  )
	                                ]
	                              )
	                            })
	      ...
	      _vm.requests.length == 0
	        ? _c(
	            ...
	            {
	              staticClass:
	                "no-result text-muted flex justify-center align-center"
	            },
	            [
	              _vm.status.status == "Inactive"
	                ? _c("div", { staticClass: "msg-box no-border" }, [
	                    _c("p", [_vm._v("Recorder is Inactive")]),
	                    _vm._v(" "),
	                    _c("p", [
	                      _c(
	                        "button",
	                ...
	                : _vm._e(),
	              _vm._v(" "),
	              _vm.status.status == "Active"
	                ? _c("div", { staticClass: "msg-box no-border" }, [
	                    _c("p", [_vm._v("No Requests found")]),
	                    _vm._v(" "),
	                    _c("p", [_vm._v("Go make some noise")])
	                  ])
	                : _vm._e()
	            ]
	          )
	        ...
	        ? _c("div", { staticClass: "list-paging-area" }, [
	            _c("div", { staticClass: "row" }, [
	              _c("div", { staticClass: "col-xs-6" }, [
	                _c(
	                  "div",
	                  { staticClass: "btn-group btn-group-paging" },
	                  _vm._l([20, 100, 500], function(limit, index) {
	                    return _c(
	                      "button",
	                      {
	                        key: index,
	                        ...
	                        class:
	                          _vm.query.pagination.limit == limit ? "btn-info" : "",
	                        attrs: { type: "button" },
	                        on: {
	                          click: function($event) {
	...
	var __vue_staticRenderFns__$1 = [
	  ...
	  function() {
	    ...
	    var _h = _vm.$createElement;
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "tag-filters-area" }, [
	      _c("div", { staticClass: "active-tag-filters" }, [
	        _c(
	          "button",
	          { staticClass: "btn btn-default btn-xs add-filter text-muted" },
	          [_vm._v("\n\t\t\t\t\t\tAdd Filter\n\t\t\t\t\t")]
	        )
	      ])
	    ])
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/recorder/RecorderDetail.vue";
	  ...
	  var RecorderDetail = __vue_normalize__$1(
	...
	var script$2 = {
	 	...
	 	data: function data() {
			return {
				columns: [
					...
					{label: "Request Headers", slug: "headers", type: "Small Text", formatter: function (value) { return ("<pre class=\"for-description like-disabled-input\">" + (JSON.stringify(value, null, 4)) + "</pre>"); }, class: "col-sm-12"},
					{label: "Form Dict", slug: "form_dict", type: "Small Text", formatter: function (value) { return ("<pre class=\"for-description like-disabled-input\">" + (JSON.stringify(value, null, 4)) + "</pre>"); }, class: "col-sm-12"} ],
				table_columns: [
		...
		methods: {
			...
			sorted: function(calls) {
				...
				var order = (this.query.order == "asc") ? 1 : -1;
				var sort = this.query.sort;
				return calls.sort(function (a,b) { return (a[sort] > b[sort]) ? order : -order; });
			},
			grouped: function(calls) {
				if(this.group_duplicates) {
					calls = calls.slice();
					return calls.uniqBy(function (call) { return call["query"]; });
				}
				return calls
			},
		},
	...
	var __vue_render__$2 = function() {
	  ...
	  return _c("div", [
	    _c(
	      "div",
	      { staticClass: "row form-section visible-section shaded-section" },
	      [
	                    ...
	                    _c("div", { staticClass: "form-group" }, [
	                      ...
	                      _c("div", {
	                        ...
	                        domProps: {
	                          innerHTML: _vm._s(
	                            column.formatter
	                              ? column.formatter(_vm.request[column.slug])
	                              : _vm.request[column.slug]
	                          )
	                        }
	                      })
	                    ])
	            ...
	            _c(
	              ...
	              [
	                _c("span", { staticClass: "dropdown-text" }, [
	                  _vm._v(
	                    _vm._s(
	                      _vm.table_columns.filter(function(c) {
	                        return c.slug == _vm.query.sort
	                      })[0].label
	                    )
	                  )
	                  ...
	                  _c("label", [
	                    _c("span", { staticClass: "input-area" }, [
	                      _c("input", {
	                        ...
	                        domProps: {
	                          checked: Array.isArray(_vm.group_duplicates)
	                            ? _vm._i(_vm.group_duplicates, null) > -1
	                            : _vm.group_duplicates
	                        },
	                        on: {
	                          change: function($event) {
	                            var $$a = _vm.group_duplicates,
	                              $$el = $event.target,
	                            ...
	                            if (Array.isArray($$a)) {
	                              ...
	                              if ($$el.checked) {
	                                $$i < 0 &&
	                                  (_vm.group_duplicates = $$a.concat([$$v]));
	                              } else {
	                                $$i > -1 &&
	                                  (_vm.group_duplicates = $$a
	                                    .slice(0, $$i)
	                                    .concat($$a.slice($$i + 1)));
	                              }
	                            } else {
	                    ...
	                    _c("span", { staticClass: "label-area small" }, [
	                      _vm._v("Group Duplicate Queries")
	                    ])
	                  ])
	                ])
	              ]
	                  ...
	                  _c("div", { staticClass: "form-grid" }, [
	                    ...
	                    _c("div", { staticClass: "grid-body" }, [
	                      _c(
	                        ...
	                        _vm._l(
	                          _vm.paginated(
	                            _vm.sorted(_vm.grouped(_vm.request.calls))
	                          ),
	                          function(call) {
	                            return _c(
	                              "div",
	                              ...
	                              [
	                                  ...
	                                  ? _c(
	                                      ...
	                                      [
	                                        ...
	                                        _c(
	                                          ...
	                                          {
	                                            staticClass:
	                                              "col grid-static-col col-xs-6",
	                                            attrs: { "data-fieldtype": "Code" }
	                                          },
	                                          [
	                                            _c(
	                                              "div",
	                                              { staticClass: "static-area" },
	                                              [
	                                                _c("span", [
	                                        ...
	                                        _c(
	                                          ...
	                                          [
	                                            _c(
	                                              ...
	                                              {
	                                                staticClass:
	                                                  "static-area ellipsis text-right"
	                                              },
	                                ...
	                                _vm.showing == call.index
	                                  ? _c(
	                                      "div",
	                                      { staticClass: "recorder-form-in-grid" },
	                                      [
	                                        _c(
	                                          "div",
	                                          {
	                      ...
	                      _vm._v(" "),
	                      _vm.request.calls.length == 0
	                        ? _c("div", { staticClass: "grid-empty text-center" }, [
	                            _vm._v("No Data")
	                          ])
	                        : _vm._e()
	                    ])
	              ...
	              _c("div", { staticClass: "row" }, [
	                _c("div", { staticClass: "col-xs-6" }, [
	                  _c(
	                    "div",
	                    { staticClass: "btn-group btn-group-paging" },
	                    _vm._l([20, 50, 100], function(limit, index) {
	                      return _c(
	                        "button",
	                        {
	                          key: index,
	...
	var __vue_staticRenderFns__$2 = [
	  ...
	  function() {
	    ...
	    var _h = _vm.$createElement;
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "grid-heading-row" }, [
	      _c("div", { staticClass: "grid-row" }, [
	        _c("div", { staticClass: "data-row row" }, [
	          ...
	          _c("div", { staticClass: "col grid-static-col col-xs-6" }, [
	            _c("div", { staticClass: "static-area ellipsis" }, [
	              _vm._v("Query")
	            ])
	          ]),
	          _vm._v(" "),
	          _c("div", { staticClass: "col grid-static-col col-xs-2" }, [
	            _c("div", { staticClass: "static-area ellipsis text-right" }, [
	              _vm._v("Duration (ms)")
	            ])
	          ]),
	          _vm._v(" "),
	  ...
	  function() {
	    ...
	    var _h = _vm.$createElement;
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "col col-xs-1" }, [
	      _c("a", { staticClass: "close btn-open-row" }, [
	        _c("span", { staticClass: "octicon octicon-triangle-down" })
	      ])
	    ])
	  },
	  function() {
	    ...
	    return _c(
	      ...
	      [_c("span", { staticClass: "hidden-xs octicon octicon-triangle-up" })]
	    )
	  },
	  function() {
	    var _vm = this;
	    ...
	    return _c("div", { staticClass: "clearfix" }, [
	      _c("label", { staticClass: "control-label" }, [_vm._v("Query")])
	    ])
	  },
	  function() {
	    var _vm = this;
	    ...
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "clearfix" }, [
	      _c("label", { staticClass: "control-label" }, [_vm._v("Duration (ms)")])
	    ])
	  },
	  function() {
	    var _vm = this;
	    ...
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "clearfix" }, [
	      _c("label", { staticClass: "control-label" }, [_vm._v("Exact Copies")])
	    ])
	  },
	  function() {
	    var _vm = this;
	    ...
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "clearfix" }, [
	      _c("label", { staticClass: "control-label" }, [_vm._v("Stack Trace")])
	    ])
	  },
	  function() {
	    var _vm = this;
	    ...
	    var _c = _vm._self._c || _h;
	    return _c("div", { staticClass: "clearfix" }, [
	      _c("label", { staticClass: "control-label" }, [_vm._v("SQL Explain")])
	    ])
	  }
	];
	__vue_render__$2._withStripped = true;
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/recorder/RequestDetail.vue";
	  ...
	  var RequestDetail = __vue_normalize__$2(
...
//# sourceMappingURL=frappe-recorder.min.js.map
