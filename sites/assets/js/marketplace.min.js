(function () {
	...
	var script = {
		...
		computed: {
			title: function title() {
				var item_name = this.item.item_name || this.item.name;
				return strip_html(item_name);
			},
			subtitle: function subtitle() {
				var dot_spacer = '<span aria-hidden="true"> · </span>';
				if(this.is_local){
					return comment_when(this.item.creation);
				} else {
					var subtitle_items = [comment_when(this.item.creation)];
					var rating = this.item.average_rating;
	        ...
	        [
	          _c(
	            ...
	            [
	              _c(
	                "div",
	                { staticClass: "hub-card-header flex justify-between" },
	                [
	                  _c(
	                    "div",
	                    { staticClass: "ellipsis", style: { width: "85%" } },
	                    [
	                      _c(
	                        "div",
	                        { staticClass: "hub-card-title ellipsis bold" },
	              ...
	              _c(
	                ...
	                [
	                  ...
	                  _c("div", { staticClass: "hub-card-overlay" }, [
	                    _vm.is_local
	                      ? _c("div", { staticClass: "hub-card-overlay-body" }, [
	                          _vm._m(0)
	                        ])
	                      : _vm._e()
	                  ])
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ItemCard.vue";
	  ...
	  var ItemCard = __vue_normalize__(
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/EmptyState.vue";
	  ...
	  var EmptyState = __vue_normalize__$1(
	...
	var __vue_render__$2 = function() {
	  ...
	  return _c(
	    "div",
	    { staticClass: "item-cards-container" },
	    [
	      _vm.items.length === 0
	        ? _c("empty-state", {
	            attrs: {
	...
	__vue_render__$2._withStripped = true;
	  ...
	  var __vue_inject_styles__$2 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-78540fa6_0", { source: "\n.item-cards-container[data-v-78540fa6] {\n\tmargin: 0 -15px;\n\toverflow: overlay;\n}\n", map: {"version":3,"sources":["/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ItemCardsContainer.vue"],"names":[],"mappings":";AAyDA;CACA,eAAA;CACA,iBAAA;AACA","file":"ItemCardsContainer.vue","sourcesContent":["<template>\n\t<div class=\"item-cards-container\">\n\t\t<empty-state\n\t\t\tv-if=\"items.length === 0\"\n\t\t\t:message=\"empty_state_message\"\n\t\t\t:action=\"empty_state_action\"\n\t\t\t:bordered=\"true\"\n\t\t\t:height=\"empty_state_height\"\n\t\t/>\n\t\t<item-card\n\t\t\tv-for=\"item in items\"\n\t\t\t:key=\"container_name + '_' +item[item_id_fieldname]\"\n\t\t\t:item=\"item\"\n\t\t\t:item_id_fieldname=\"item_id_fieldname\"\n\t\t\t:is_local=\"is_local\"\n\t\t\t:on_click=\"on_click\"\n\t\t\t:allow_clear=\"editable\"\n\t\t\t:seen=\"item.hasOwnProperty('seen') ? item.seen : true\"\n\t\t\t@remove-item=\"$emit('remove-item', item[item_id_fieldname])\"\n\t\t>\n\t\t</item-card>\n\t</div>\n</template>\n\n<script>\nimport ItemCard from './ItemCard.vue';\nimport EmptyState from './EmptyState.vue';\n\nexport default {\n\tname: 'item-cards-container',\n\tprops: {\n\t\tcontainer_name: String,\n\t\titems: Array,\n\t\titem_id_fieldname: String,\n\t\tis_local: Boolean,\n\t\ton_click: Function,\n\t\teditable: Boolean,\n\n\t\tempty_state_message: String,\n\t\tempty_state_action: Object,\n\t\tempty_state_height: Number,\n\t\tempty_state_bordered: Boolean\n\t},\n\tcomponents: {\n\t\tItemCard,\n\t\tEmptyState\n\t},\n\twatch: {\n\t\titems() {\n\t\t\t// TODO: handling doesn't work\n\t\t\tfrappe.dom.handle_broken_images($(this.$el));\n\t\t}\n\t}\n}\n</script>\n\n<style scoped>\n\t.item-cards-container {\n\t\tmargin: 0 -15px;\n\t\toverflow: overlay;\n\t}\n</style>\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$2 = "data-v-78540fa6";
	  /* module identifier */
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ItemCardsContainer.vue";
	  ...
	  var ItemCardsContainer = __vue_normalize__$2(
	...
	var __vue_render__$3 = function() {
	  ...
	  return _c(
	    "div",
	    { staticClass: "hub-items-header level" },
	    [_vm._t("default")],
	    2
	  )
	};
	...
	__vue_render__$3._withStripped = true;
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/SectionHeader.vue";
	  ...
	  var SectionHeader = __vue_normalize__$3(
	...
	__vue_render__$4._withStripped = true;
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/SearchInput.vue";
	  ...
	  var SearchInput = __vue_normalize__$4(
	              ...
	              _c(
	                ...
	                [
	                  ...
	                  _c(
	                    "div",
	                    { staticClass: "text-muted" },
	                    [_vm._t("detail-header-item")],
	                    2
	                  )
	                ]
	              ),
	              _vm._v(" "),
	              _vm.menu_items && _vm.menu_items.length
	                ? _c("div", { staticClass: "col-md-1" }, [
	                    _c(
	                      "div",
	                      { staticClass: "dropdown pull-right hub-item-dropdown" },
	                      [
	                        _vm._m(2),
	                        _vm._v(" "),
	                        _c(
	                          ...
	                          _vm._l(_vm.menu_items, function(menu_item) {
	                            return menu_item.condition
	                              ? _c("li", { key: menu_item.label }, [
	  ...
	  function() {
	    ...
	    return _c("div", { staticClass: "col-md-6" }, [
	      ...
	      _c("div", { staticClass: "text-muted" }, [
	        _c(
	          "p",
	          { staticClass: "hub-skeleton", staticStyle: { width: "35%" } },
	          [_vm._v("Details")]
	        ),
	        _vm._v(" "),
	        _c(
	          "p",
	          { staticClass: "hub-skeleton", staticStyle: { width: "50%" } },
	          [_vm._v("Ratings")]
	        )
	      ]),
	      _vm._v(" "),
	      ...
	      _c("div", { staticClass: "hub-item-description" }, [
	        ...
	        _c(
	          "p",
	          { staticClass: "hub-skeleton", staticStyle: { width: "85%" } },
	          [_vm._v("Desc")]
	        )
	      ])
	    ])
	...
	__vue_render__$5._withStripped = true;
	  ...
	  /* scoped */
	  var __vue_scope_id__$5 = "data-v-8e502456";
	  /* module identifier */
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/DetailView.vue";
	  ...
	  var DetailView = __vue_normalize__$5(
	...
	var __vue_render__$6 = function() {
	  ...
	  var _h = _vm.$createElement;
	  var _c = _vm._self._c || _h;
	  return !Array.isArray(this.header_items)
	    ? _c("p", {
	        staticClass: "text-muted",
	    ...
	    : _c(
	        "p",
	        { staticClass: "text-muted" },
	        _vm._l(_vm.header_items, function(header_item, index) {
	          return _c("span", { key: index }, [
	            index
	              ? _c("span", { domProps: { innerHTML: _vm._s(_vm.spacer) } })
	              : _vm._e(),
	            _vm._v(" "),
	            typeof header_item == "string"
	              ? _c("span", { domProps: { innerHTML: _vm._s(header_item) } })
	              : typeof header_item == "object"
	              ? _c("a", {
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/DetailHeaderItem.vue";
	  ...
	  var DetailHeaderItem = __vue_normalize__$6(
	...
	var script$6 = {
		...
		methods: {
			handle_image: function handle_image() {
				var this$1 = this;
				...
				img.onload = function () {
					this$1.is_loading = false;
				};
				img.onerror = function () {
					this$1.is_loading = false;
					this$1.is_broken = true;
				};
			}
		}
	};
	...
	var __vue_render__$7 = function() {
	  ...
	  return _c("div", { staticClass: "hub-image" }, [
	    ...
	    _vm._v(" "),
	    _vm.is_loading
	      ? _c("div", { staticClass: "hub-image-loading" }, [
	          _c("span", { staticClass: "octicon octicon-cloud-download" })
	        ])
	      : _vm._e(),
	    _vm._v(" "),
	    _vm.is_broken
	      ? _c("div", { staticClass: "hub-image-broken" }, [
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/Image.vue";
	  ...
	  var Image$1 = __vue_normalize__$7(
	...
	Vue.component('base-image', Image$1);
	...
	Vue.directive('route', {
		bind: function bind(el, binding) {
			...
			el.addEventListener('click', function () { return frappe.set_route(route); });
		},
	...
	var script$7 = {
		...
		methods: {
			get_items: function get_items() {
				...
				.then(function (data) {
					this$1.show_skeleton = false;

					this$1.sections.push({
						title: __('Explore'),
					...
					if (category_items) {
						Object.keys(category_items).map(function (category) {
							var items = category_items[category];
			...
			go_to_item_details_page: function go_to_item_details_page(hub_item_name) {
				frappe.set_route(("marketplace/item/" + hub_item_name));
			},

			set_search_route: function set_search_route() {
	        ...
	        ? _c(
	            ...
	            [
	              ...
	              _c(
	                "div",
	                { staticClass: "row" },
	                _vm._l([1, 2, 3, 4, 5, 6, 7], function(f, $index) {
	                  return _c(
	                    "div",
	                    {
	                      key: $index,
	                      staticClass:
	                        "col-md-3 col-sm-4 col-xs-6 hub-card-container"
	                    },
	                    [
	                      _c("div", {
	                  ...
	                  section.expandable
	                    ? _c(
	                        "p",
	                        {
	                          attrs: {
	                            "data-route":
	                              "marketplace/category/" + section.title
	                          }
	                        },
	                        [_vm._v(_vm._s("See All"))]
	                      )
	                    : _vm._e()
	                ]),
	                _vm._v(" "),
	...
	__vue_render__$8._withStripped = true;
	  ...
	  var __vue_inject_styles__$8 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-590eff71_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Home.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$8 = "data-v-590eff71";
	  /* module identifier */
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Home.vue";
	...
	var script$8 = {
		...
		methods: {
			...
			set_route_and_get_items: function set_route_and_get_items() {
				frappe.set_route('marketplace', 'search', this.search_value);
				this.get_items();
			},
	...
	__vue_render__$9._withStripped = true;
	  ...
	  var __vue_inject_styles__$9 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-4d439a33_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Search.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$9 = "data-v-4d439a33";
	  /* module identifier */
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Search.vue";
	  ...
	  var Search = __vue_normalize__$9(
	...
	__vue_render__$a._withStripped = true;
	  ...
	  var __vue_inject_styles__$a = function (inject) {
	    if (!inject) { return }
	    inject("data-v-58d8c6fd_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Category.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$a = "data-v-58d8c6fd";
	  /* module identifier */
	  ...
	  function __vue_normalize__$a(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Category.vue";
	  ...
	  var Category = __vue_normalize__$a(
	...
	var script$a = {
		...
		methods: {
			...
			on_item_remove: function on_item_remove(hub_item_name) {
				var this$1 = this;
				...
				var undo_remove = function () {
					this$1.toggle_item(hub_item_name);				reverted = true;
					alert.hide();
					return false;
				};

				var item_name = this.items.filter(function (item) { return item.hub_item_name === hub_item_name; });
				...
				setTimeout(function () {
					if(!reverted) {
						this$1.remove_item_from_saved_items(hub_item_name);
					}
				}, grace_period);
			},

			remove_item_from_saved_items: function remove_item_from_saved_items(hub_item_name) {
				var this$1 = this;
			...
			// By default show
			toggle_item: function toggle_item(hub_item_name, show) {
	...
	__vue_render__$b._withStripped = true;
	  ...
	  var __vue_inject_styles__$b = function (inject) {
	    if (!inject) { return }
	    inject("data-v-6be7d52a_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"SavedItems.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$b = "data-v-6be7d52a";
	  /* module identifier */
	  ...
	  function __vue_normalize__$b(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/SavedItems.vue";
	  ...
	  var SavedItems = __vue_normalize__$b(
	...
	var script$b = {
		...
		methods: {
			...
			on_item_remove: function on_item_remove(hub_item_name) {
				...
				setTimeout(function () {
					if(!reverted) {
						this$1.remove_item_from_featured_items(hub_item_name);
					}
				}, grace_period);
			},

			remove_item_from_featured_items: function remove_item_from_featured_items(hub_item_name) {
				var this$1 = this;
	...
	var __vue_render__$c = function() {
	  ...
	  return _c(
	    ...
	    [
	      ...
	      _vm._v(" "),
	      _vm.items.length
	        ? _c("p", { staticClass: "text-muted margin-bottom" }, [
	            _vm._v(
	              "\n\t\t" +
	...
	__vue_render__$c._withStripped = true;
	  ...
	  var __vue_inject_styles__$c = function (inject) {
	    if (!inject) { return }
	    inject("data-v-126dae4a_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"FeaturedItems.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$c = "data-v-126dae4a";
	  /* module identifier */
	  ...
	  function __vue_normalize__$c(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/FeaturedItems.vue";
	  ...
	  var FeaturedItems = __vue_normalize__$c(
	      ...
	      _c("section-header", [
	        ...
	        _vm.items.length
	          ? _c(
	              ...
	              [_c("span", [_vm._v(_vm._s(_vm.__("Publish More Items")))])]
	            )
	          : _vm._e()
	      ]),
	      _vm._v(" "),
	...
	__vue_render__$d._withStripped = true;
	  ...
	  var __vue_inject_styles__$d = function (inject) {
	    if (!inject) { return }
	    inject("data-v-07ce37a6_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"PublishedItems.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$d = "data-v-07ce37a6";
	  /* module identifier */
	  ...
	  function __vue_normalize__$d(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/PublishedItems.vue";
	  ...
	  var PublishedItems = __vue_normalize__$d(
	...
	var __vue_render__$e = function() {
	  ...
	  return _c(
	    "span",
	    _vm._l(_vm.max_rating, function(index) {
	      return _c("i", {
	        key: index,
	...
	__vue_render__$e._withStripped = true;
	  ...
	  function __vue_normalize__$e(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/Rating.vue";
	  ...
	  var Rating = __vue_normalize__$e(
	...
	__vue_render__$f._withStripped = true;
	  ...
	  function __vue_normalize__$f(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ReviewTimelineItem.vue";
	  ...
	  var ReviewTimelineItem = __vue_normalize__$f(
	...
	var script$f = {
		...
		components: {
			ReviewTimelineItem: ReviewTimelineItem
		},
		created: function created() {
		...
		methods: {
			set_rating: function set_rating(i) {
				this.user_review.rating = i;
			},

			when: function when(datetime) {
				return comment_when(datetime);
			},

			get_item_reviews: function get_item_reviews() {
				var this$1 = this;

				hub.call('get_item_reviews', { hub_item_name: this.hub_item_name })
					.then(function (reviews) {
						this$1.reviews = reviews;
					})
					.catch(function () {});
			},
			...
			on_submit_review: function on_submit_review() {
				var review = Object.assign({}, this.user_review, {
			...
			reset_user_review: function reset_user_review() {
	    ...
	    _c("div", { staticClass: "timeline-head" }, [
	      _c("div", { staticClass: "comment-input-wrapper" }, [
	        ...
	        _c("div", { staticClass: "comment-input-container" }, [
	          _c(
	            "div",
	            { staticClass: "rating-area text-muted" },
	            [
	...
	__vue_render__$g._withStripped = true;
	  ...
	  function __vue_normalize__$g(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ReviewArea.vue";
	  ...
	  var ReviewArea = __vue_normalize__$g(
	...
	var script$g = {
		...
		computed: {
			is_own_item: function is_own_item() {
				var is_own_item = false;
				if(this.item) {
			...
			item_subtitle: function item_subtitle() {
				if(!this.item) {
					return '';
				}
				var subtitle_items = [comment_when(this.item.creation)];
			...
			item_views_and_ratings: function item_views_and_ratings() {
				if(!this.item) {
					return '';
				}

				var stats = __('No views yet');
				if(this.item.view_count) {
					var views_message = __(((this.item.view_count) + " Views"));

					var rating_html = get_rating_html(this.item.average_rating);
					var rating_count = this.item.no_of_ratings > 0 ? ((this.item.no_of_ratings) + " reviews") : __('No reviews yet');
		...
		mounted: function mounted() {
			...
			this.item_received.then(function () {
				setTimeout(function () {
					hub.call('add_item_view', {
						hub_item_name: this$1.hub_item_name
					});
					// .then(() => {
		...
		methods: {
			...
			go_to_seller_profile_page: function go_to_seller_profile_page(seller_name) {
			...
			make_dialogs: function make_dialogs() {
				this.make_contact_seller_dialog();
				this.make_report_item_dialog();
			},

			add_to_saved_items: function add_to_saved_items() {
				hub.call('add_item_to_user_saved_items', {
					hub_item_name: this.hub_item_name,
					hub_user: frappe.session.user
				})
				.then(function () {
					var saved_items_link = "<b><a href=\"#marketplace/saved-items\">" + (__('Saved')) + "</a></b>";
			...
			add_to_featured_items: function add_to_featured_items() {
				hub.call('add_item_to_seller_featured_items', {
					hub_item_name: this.hub_item_name,
					hub_user: frappe.session.user
				})
				.then(function () {
					var featured_items_link = "<b><a href=\"#marketplace/featured-items\">" + (__('Added to Featured Items')) + "</a></b>";
			...
			make_contact_seller_dialog: function make_contact_seller_dialog() {
				var this$1 = this;
				...
				this.contact_seller_dialog = new frappe.ui.Dialog({
					...
					primary_action: function (ref) {
						...
						hub.call('send_message', {
							hub_item: this$1.item.name,
							message: message
						})
							.then(function () {
								this$1.contact_seller_dialog.hide();
								frappe.set_route('marketplace', 'buying', this$1.item.name);
			...
			make_report_item_dialog: function make_report_item_dialog() {
				var this$1 = this;
				...
				this.report_item_dialog = new frappe.ui.Dialog({
					...
					primary_action: function (ref) {
						...
						hub.call('add_reported_item', { hub_item_name: this$1.item.name, message: message })
							.then(function () {
								d.hide();
			...
			contact_seller: function contact_seller() {
				this.contact_seller_dialog.show();
			},

			report_item: function report_item() {
				if (!hub.is_seller_registered()) {
			...
			edit_details: function edit_details() {
				frappe.msgprint(__('This feature is under development...'));
			},

			unpublish_item: function unpublish_item() {
				frappe.msgprint(__('This feature is under development...'));
			}
		}
	};
	  ...
	  return _vm.init || _vm.item
	    ? _c(
	        ...
	        [
	            ...
	            [
	              ...
	              _vm.primary_action
	                ? _c(
	                    ...
	                    [
	                      _vm._v(
	                        "\n\t\t\t" + _vm._s(_vm.primary_action.label) + "\n\t\t"
	                      )
	                    ]
	                  )
	                : _vm._e()
	          ...
	          _vm._v(" "),
	          !_vm.init
	            ? _c("review-area", { attrs: { hub_item_name: _vm.hub_item_name } })
	            : _vm._e()
	        ],
	        1
	      )
	...
	__vue_render__$h._withStripped = true;
	  ...
	  var __vue_inject_styles__$h = function (inject) {
	    if (!inject) { return }
	    inject("data-v-96ee099c_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Item.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$h = "data-v-96ee099c";
	  /* module identifier */
	  ...
	  function __vue_normalize__$h(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Item.vue";
	...
	var script$h = {
		...
		computed: {
			is_own_company: function is_own_company() {
				var is_own_company = false;
				if(this.hub_seller) {
		...
		methods: {
			comment_when: function comment_when$1(timestamp){
				return comment_when(timestamp)
			},
			is_user_registered: function is_user_registered(){
				return hub.is_user_registered()
			},
			get_seller_profile_and_items: function get_seller_profile_and_items() {
				var this$1 = this;

				var post_data = {company: this.seller_company};
				...
				.then(function (data) {
					this$1.init = false;
					this$1.profile = data.profile;
					this$1.items = data.items;
					this$1.item_container_heading = data.is_featured_item? "Features Items":"Popular Items";
					this$1.hub_seller = this$1.items[0].hub_seller;
					this$1.recent_seller_reviews = data.recent_seller_reviews;
					this$1.seller_product_view_stats = data.seller_product_view_stats;

					var profile = this$1.profile;

					this$1.title = profile.company;

					this$1.country = __(profile.country);
					this$1.site_name = __(profile.site_name);
					this$1.joined_when = __(("Joined " + (comment_when(profile.creation))));

					this$1.image = profile.logo;
					this$1.sections = [
						{
					...
					setTimeout(function () { return this$1.init_seller_traffic_chart(); }, 1);
			...
			go_to_seller_items_page: function go_to_seller_items_page(hub_seller) {
				frappe.set_route(("marketplace/seller/" + hub_seller + "/items"));
			},
			init_seller_traffic_chart: function init_seller_traffic_chart() {
				var this$1 = this;

				var lables = [];
				var tooltip_lables = {};
				var datasets = [{name:"Product Views",chartType: 'line',values: []}];
				this.seller_product_view_stats.map(function (stat) {
				...
				var data = {labels: lables, datasets:datasets, tooltip_lables:tooltip_lables};
				...
				tooltipOptions: {
				formatTooltipX: function (d) { return this$1.seller_traffic_chart.data.tooltip_lables[d]; },
				formatTooltipY: function (d) { return d + ' Views'; },
				}
			});
			}
		}
	    ...
	    ? _c(
	        ...
	        [
	          ...
	          _vm.items.length
	            ? _c(
	                ...
	                [
	                  _c("h5", [
	                    ...
	                    _vm.is_user_registered() && _vm.is_own_company
	                      ? _c("small", [
	                          _c(
	                            "a",
	                            {
	            ...
	            : _vm._e(),
	          _vm._v(" "),
	          _vm.recent_seller_reviews.length
	            ? _c(
	                "div",
	                [
	                  ...
	                  _vm._l(_vm.recent_seller_reviews, function(review) {
	                    return _c(
	                      "div",
	                      { key: review.name, staticClass: "container" },
	                      [
	                        _c("br"),
	                        _vm._v(" "),
	                        _c(
	                        ...
	                        _c("i", {
	                          staticClass:
	                            "octicon octicon-quote hidden-xs fa-fw fa-rotate-180"
	                        }),
	                        _vm._v(" "),
	                        _c("div", { staticClass: "container" }, [
	                          ...
	                          _c("a", { staticClass: "text-muted" }, [
	                            _c(
	                              "span",
	                              { staticClass: "text-muted hidden-xs" },
	                              [_vm._v("–")]
	                            ),
	                            _vm._v(" "),
	                            _c("span", {
	                              ...
	                              domProps: {
	                                innerHTML: _vm._s(
	                                  _vm.comment_when(review.timestamp)
	                                )
	                              }
	                            })
	                          ])
	            ...
	            : _vm._e(),
	          _vm._v(" "),
	          _vm.seller_product_view_stats.length
	            ? _c("div", [
	                _c("h5", [_vm._v("Stats")]),
	                _vm._v(" "),
	...
	__vue_render__$i._withStripped = true;
	  ...
	  var __vue_inject_styles__$i = function (inject) {
	    if (!inject) { return }
	    inject("data-v-efd82b02_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Seller.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$i = "data-v-efd82b02";
	  /* module identifier */
	  ...
	  function __vue_normalize__$i(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Seller.vue";
	  ...
	  var Seller = __vue_normalize__$i(
	...
	var script$i = {
		...
		computed: {
			item_container_heading: function item_container_heading() {
				return __('Items by ' + this.seller_company);
			}
		},
		methods: {
			get_seller_and_items: function get_seller_and_items() {
				var this$1 = this;
	...
	var __vue_render__$j = function() {
	  ...
	  var _h = _vm.$createElement;
	  var _c = _vm._self._c || _h;
	  return _vm.init || _vm.items.length
	    ? _c(
	        "div",
	        {
	          staticClass: "marketplace-page",
	...
	__vue_render__$j._withStripped = true;
	  ...
	  var __vue_inject_styles__$j = function (inject) {
	    if (!inject) { return }
	    inject("data-v-68cdf98f_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"SellerItems.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$j = "data-v-68cdf98f";
	  /* module identifier */
	  ...
	  function __vue_normalize__$j(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/SellerItems.vue";
	  ...
	  var SellerItems = __vue_normalize__$j(
	...
	var __vue_render__$k = function() {
	  ...
	  var _c = _vm._self._c || _h;
	  return _vm.message
	    ? _c("div", { staticClass: "subpage-message" }, [
	...
	__vue_render__$k._withStripped = true;
	  ...
	  function __vue_normalize__$k(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/NotificationMessage.vue";
	  ...
	  var NotificationMessage = __vue_normalize__$k(
	...
	function ItemPublishDialog(primary_action, secondary_action) {
		...
		hub.call('get_categories')
			.then(function (categories) {
				categories = categories.map(function (d) { return d.name; });
	...
	var script$k = {
		...
		computed: {
			no_selected_items: function no_selected_items() {
				return this.selected_items.length === 0;
			},

			publish_button_text: function publish_button_text() {
				var number = this.selected_items.length;
				var text = __('Publish');
				if(number === 1) {
			...
			items_dict: function items_dict() {
				var this$1 = this;

				var items_dict = {};
				this.valid_items.map(function (item) {
					items_dict[item[this$1.item_id_fieldname]] = item;
				});
		...
		methods: {
			get_valid_items: function get_valid_items() {
				var this$1 = this;
				...
				.then(function (r) {
					this$1.valid_items = r.message;
				});
			},

			publish_selected_items: function publish_selected_items() {
				var this$1 = this;
				...
				.then(function (r) {
					this$1.selected_items = [];
					return frappe.db.get_doc('Marketplace Settings');
				})
				.then(function (doc) {
					hub.settings = doc;
					this$1.add_last_sync_message();
				});
			},

			add_last_sync_message: function add_last_sync_message() {
				this.last_sync_message = __(("Last sync was\n\t\t\t\t<a href=\"#marketplace/profile\">\n\t\t\t\t\t" + (comment_when(hub.settings.last_sync_datetime)) + "</a>.\n\t\t\t\t<a href=\"#marketplace/published-items\">\n\t\t\t\t\tSee your Published Items</a>."));
			},

			clear_last_sync_message: function clear_last_sync_message() {
				this.last_sync_message = '';
			},

			remove_item_from_selection: function remove_item_from_selection(item_code) {
				this.selected_items = this.selected_items
					.filter(function (item) { return item.item_code !== item_code; });
			},

			make_publishing_dialog: function make_publishing_dialog() {
				var this$1 = this;

				this.item_publish_dialog = ItemPublishDialog(
					{
						fn: function (values) {
							this$1.add_item_to_publish(values);
							this$1.item_publish_dialog.hide();
						}
					},
					{
						fn: function () {
							var values = this$1.item_publish_dialog.get_values(true);
							this$1.update_items_data_to_publish(values);
						}
					}
				);
			},

			add_item_to_publish: function add_item_to_publish(values) {
				this.update_items_data_to_publish(values);

				var item_code  = values.item_code;
				var item_doc = this.items_dict[item_code];

				var item_to_publish = Object.assign({}, item_doc, values);
				this.selected_items.push(item_to_publish);
			},

			update_items_data_to_publish: function update_items_data_to_publish(values) {
				this.items_data_to_publish[values.item_code] = values;
			},

			show_publishing_dialog_for_item: function show_publishing_dialog_for_item(item_code) {
				var item_data = this.items_data_to_publish[item_code];
				if(!item_data) { item_data = { item_code: item_code }; }
				this.item_publish_dialog.clear();

				var item_doc = this.items_dict[item_code];
				if(item_doc) {
					this.item_publish_dialog.fields_dict.image_list.set_data(
						item_doc.attachments.map(function (attachment) { return attachment.file_url; })
					);
				}
	...
	var __vue_render__$l = function() {
	  ...
	  return _c(
	    ...
	    [
	      ...
	      _c(
	        "div",
	        { staticClass: "flex justify-between align-flex-end margin-bottom" },
	        [
	          _c("h5", [_vm._v(_vm._s(_vm.page_title))]),
	          _vm._v(" "),
	          _c(
	...
	__vue_render__$l._withStripped = true;
	  ...
	  var __vue_inject_styles__$l = function (inject) {
	    if (!inject) { return }
	    inject("data-v-261c6595_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Publish.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$l = "data-v-261c6595";
	  /* module identifier */
	  ...
	  function __vue_normalize__$l(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Publish.vue";
	  ...
	  var Publish = __vue_normalize__$l(
	...
	var __vue_render__$m = function() {
	  ...
	  return _c(
	    "div",
	    { staticClass: "hub-list-item", attrs: { "data-route": _vm.item.route } },
	    [
	      _c(
	        "div",
	        { staticClass: "hub-list-left" },
	        [
	          _c("base-image", {
	          ...
	          _c("div", { staticClass: "hub-list-body ellipsis" }, [
	            ...
	            _c(
	              "div",
	              { staticClass: "hub-list-subtitle ellipsis" },
	              [_vm._t("subtitle")],
	              2
	            )
	          ])
	      ...
	      _vm._v(" "),
	      _vm.message
	        ? _c("div", { staticClass: "hub-list-right" }, [
	            _c("span", {
	              staticClass: "text-muted",
	              domProps: {
	                innerHTML: _vm._s(
	                  _vm.frappe.datetime.comment_when(_vm.message.creation, true)
	                )
	              }
	            })
	          ])
	...
	__vue_render__$m._withStripped = true;
	  ...
	  function __vue_normalize__$m(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/ItemListCard.vue";
	  ...
	  var ItemListCard = __vue_normalize__$m(
	...
	var script$m = {
		...
		methods: {
			get_items_for_messages: function get_items_for_messages() {
				return hub.call('get_buying_items_for_messages', {}, 'action:send_message');
			},
			get_sender: function get_sender(message) {
	      ...
	      _vm.items && _vm.items.length
	        ? _c(
	            ...
	            _vm._l(_vm.items, function(item) {
	              return _c(
	                "div",
	                { key: item.name, staticClass: "col-md-7 margin-bottom" },
	                [
	                  _c(
	                    "item-list-card",
	                    {
	                    ...
	                    [
	                      _c(
	                        ...
	                        [
	                          _c("span", [
	                            _vm._v(
	                              _vm._s(_vm.get_sender(item.recent_message)) + ": "
	                            )
	                          ]),
	                          _vm._v(" "),
	                          _c("span", [
	                            _vm._v(
	                              _vm._s(
	                                _vm._f("striphtml")(item.recent_message.message)
	                              )
	                            )
	                          ])
	                        ]
	...
	__vue_render__$n._withStripped = true;
	  ...
	  function __vue_normalize__$n(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Buying.vue";
	  ...
	  var Buying = __vue_normalize__$n(
	        ...
	        ? _c(
	            ...
	            _vm._l(_vm.items, function(item) {
	              return _c(
	                ...
	                [
	                  _c("item-list-card", { attrs: { item: item } }, [
	                    _c(
	                      "div",
	                      { attrs: { slot: "subtitle" }, slot: "subtitle" },
	                      [
	                        ...
	                        directives: [
	                          {
	                            ...
	                            value:
	                              ...
	                              item.name,
	                            expression:
	                              "'marketplace/selling/' + message.buyer + '/' + item.name"
	                          }
	                        ],
	                        key: index,
	                            ...
	                            _c("div", { staticClass: "hub-list-subtitle" }, [
	                              _vm._v(
	                                "\n\t\t\t\t\t\t\t" +
	                                  ...
	                                  ": " +
	                                  _vm._s(_vm._f("striphtml")(message.message)) +
	                                  "\n\t\t\t\t\t\t"
	                              )
	                            ])
	                          ])
	...
	__vue_render__$o._withStripped = true;
	  ...
	  function __vue_normalize__$o(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Selling.vue";
	  ...
	  var Selling = __vue_normalize__$o(
			...
			make_input: function make_input() {
				...
				this.message_input = frappe.ui.form.make_control({
					...
					on_submit: function (message) {
						this$1.message_input.reset();
						this$1.$emit('change', message);
					},
					only_input: true,
					no_wrapper: true
				});
			},
			submit_input: function submit_input() {
				if (!this.message_input) { return; }
				var value = this.message_input.get_value();
				if (!value) { return; }
	...
	__vue_render__$p._withStripped = true;
	  ...
	  function __vue_normalize__$p(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/components/CommentInput.vue";
	  ...
	  var CommentInput = __vue_normalize__$p(
	...
	var script$p = {
		...
		created: function created() {
			...
			var hub_item_name = this.get_hub_item_name();
			this.get_item_details(hub_item_name)
				.then(function (item_details) {
					this$1.item_details = item_details;
					this$1.get_messages()
						.then(function (messages) {
							this$1.messages = messages;
						});
				});
		},
		computed: {
		...
		methods: {
			...
			get_item_details: function get_item_details(hub_item_name) {
				return hub.call('get_item_details', { hub_item_name: hub_item_name })
			},
			...
			get_against_seller: function get_against_seller() {
			...
			get_hub_item_name: function get_hub_item_name() {
				if (this.message_type === 'buying') {
					return frappe.get_route()[2];
				} else if (this.message_type === 'selling') {
	              ...
	              _c("div", { staticClass: "message-container" }, [
	                _c(
	                  ...
	                  _vm._l(_vm.messages, function(message) {
	                    return _c(
	                      "div",
	                      { key: message.name, staticClass: "level margin-bottom" },
	                      [
	                        _c(
	                          "div",
	                          {
	                          ...
	                          [
	                            _c("div", {
	                              domProps: {
	                                innerHTML: _vm._s(
	                                  _vm.frappe.avatar(message.sender)
	                                )
	                              }
	                            }),
	                            _vm._v(" "),
	                        ...
	                        _c("div", {
	                          ...
	                          domProps: {
	                            innerHTML: _vm._s(
	                              _vm.frappe.datetime.comment_when(
	                                message.creation,
	                                true
	                              )
	                            )
	                ...
	                _c(
	                  ...
	                  [_c("comment-input", { on: { change: _vm.send_message } })],
	                  1
	                )
	              ])
	            ])
	...
	__vue_render__$q._withStripped = true;
	  ...
	  function __vue_normalize__$q(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/Messages.vue";
	  ...
	  var Messages = __vue_normalize__$q(
	...
	__vue_render__$r._withStripped = true;
	  ...
	  var __vue_inject_styles__$r = function (inject) {
	    if (!inject) { return }
	    inject("data-v-3b41620c_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"NotFound.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$r = "data-v-3b41620c";
	  /* module identifier */
	  ...
	  function __vue_normalize__$r(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/pages/NotFound.vue";
	  ...
	  var NotFound = __vue_normalize__$r(
	...
	var script$r = {
		...
		methods: {
			...
			get_current_page: function get_current_page() {
				...
				var curr_route = frappe.get_route_str();
				var route = Object.keys(route_map).filter(function (route) { return route == curr_route; })[0];
				if (!route) {
					// find route by matching it with dynamic part
					var curr_route_parts = curr_route.split('/');
					var weighted_routes = Object.keys(route_map)
						.map(function (route_str) { return route_str.split('/'); })
						.filter(function (route_parts) { return route_parts.length === curr_route_parts.length; })
						.reduce(function (obj, route_parts) {
							var key = route_parts.join('/');
							var weight = 0;
							route_parts.forEach(function (part, i) {
								var curr_route_part = curr_route_parts[i];
					...
					for (var key in weighted_routes) {
						var route_weight = weighted_routes[key];
	...
	var __vue_render__$s = function() {
	  ...
	  return _c(
	    "div",
	    { staticClass: "hub-page-container" },
	    [
	...
	__vue_render__$s._withStripped = true;
	  ...
	  function __vue_normalize__$s(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/PageContainer.vue";
	  ...
	  var PageContainer = __vue_normalize__$s(
	...
	var script$s = {
			...
			return {
				...
				items: [
					...
					},
					{
						...
						condition: function () { return this$1.hub_registered; }
					},
					{
		...
		created: function created() {
			...
			this.get_categories()
				.then(function (categories) {
					this$1.categories = categories.map(function (c) {
						return {
							label: __(c.name),
							route: 'marketplace/category/' + c.name
						}
					});
					this$1.categories.unshift({
						label: __('All'),
						route: 'marketplace/home'
					});
					this$1.$nextTick(function () {
						this$1.update_sidebar_state();
					});
				});

			erpnext.hub.on('seller-registered', function () {
				this$1.hub_registered = true;
			});
		},
		mounted: function mounted() {
			var this$1 = this;
			...
			frappe.route.on('change', function () { return this$1.update_sidebar_state(); });
		},
		methods: {
			get_categories: function get_categories() {
				return hub.call('get_categories');
			},
			update_sidebar_state: function update_sidebar_state() {
				var container = $(this.$refs['sidebar-container']);
				var route = frappe.get_route();
				var route_str = route.join('/');
				var part_route_str = route.slice(0, 2).join('/');
				var $sidebar_item = container.find(("[data-route=\"" + route_str + "\"], [data-route=\"" + part_route_str + "\"]"));

				var $siblings = container.find('[data-route]');
	          ...
	          "li",
	          {
	            directives: [
	              ...
	              },
	              {
	                name: "show",
	                rawName: "v-show",
	                value: item.condition === undefined || item.condition(),
	...
	__vue_render__$t._withStripped = true;
	  ...
	  function __vue_normalize__$t(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/erpnext/erpnext/public/js/hub/Sidebar.vue";
	  ...
	  var Sidebar = __vue_normalize__$t(
	...
	var ProfileDialog = function (title, action) {
		if ( title === void 0 ) title = __('Edit Profile');
		...
		var dialog = new frappe.ui.Dialog({
			...
			primary_action: function () {
				var form_values = dialog.get_values();
				...
				var mandatory_fields = ['company', 'company_description'];
				mandatory_fields.forEach(function (field) {
					var value = form_values[field];
					if (!value) {
	...
	hub.call = function call_hub_method(method, args, clear_cache_on_event) {
	 ...
	 // eslint-disable-line
		return new Promise(function (resolve, reject) {
			...
			// cache invalidation
			var clear_cache = function () { return delete erpnext.hub.cache[key]; };

			if (!clear_cache_on_event) {
				invalidate_after_5_mins(clear_cache);
			} else {
				erpnext.hub.on(clear_cache_on_event, function () {
					clear_cache(key);
				});
			}
			...
			res.then(function (r) {
				if (r.message) {
					...
					erpnext.hub.trigger(("response:" + key), { response: response });
					resolve(response);
				}
				reject(r);
	...
	erpnext.hub.Marketplace = class Marketplace {
		...
		var parent = ref.parent;
			...
			this.update_hub_settings().then(function () {
				...
				if (!hub.is_server) {
					if (!hub.is_seller_registered()) {
						this$1.page.set_primary_action('Become a Seller', this$1.show_register_dialog.bind(this$1));
					} else {
						this$1.page.set_secondary_action('Add Users', this$1.show_add_user_dialog.bind(this$1));
					}
				}
			});
		}
		...
		setup_events() {
			...
			this.$parent.on('click', '[data-route]', function (e) {
			...
			this.$parent.on('click', '[data-action]', function (e) {
				var $target = $(e.currentTarget);
				var action = $target.data().action;

				if (action && this$1[action]) {
					this$1[action].apply(this$1, $target);
				}
			});
		}
		...
		make_sidebar() {
			...
			new Vue({
				...
				render: function (h) { return h(Sidebar); }
			});
		}
		...
		make_body() {
			...
			new Vue({
				...
				render: function (h) { return h(PageContainer); }
			});
		...
		register_marketplace(ref) {
			var this$1 = this;
			var company = ref.company;
			var company_description = ref.company_description;
			...
			frappe.call({
				...
				if (r.message && r.message.ok) {
					this$1.register_dialog.hide();

					this$1.update_hub_settings()
						.then(function () {
							frappe.set_route('marketplace', 'publish');
			...
			this.get_unregistered_users()
				.then(function (r) {
					...
					var d = new frappe.ui.Dialog({
						...
						primary_action: function primary_action(ref) {
							var users = ref.users;

							var selected_users = users.split(',').map(function (d) { return d.trim(); }).filter(Boolean);

							if (!selected_users.every(function (user) { return user_list.includes(user); })) {
		...
		update_hub_settings() {
			return hub.get_settings().then(function (doc) {
				hub.settings = doc;
			});
		}
	};
	...
	Object.assign(hub, {
		is_seller_registered: function is_seller_registered() {
			return hub.settings.registered;
		},

		is_user_registered: function is_user_registered() {
			return this.is_seller_registered() && hub.settings.users
				.filter(function (hub_user) { return hub_user.user === frappe.session.user; })
				.length === 1;
		},
