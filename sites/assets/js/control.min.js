(function () {
	...
	var font_names = fonts.map(function (font) { return get_font_name(font); });
	// add fonts to style
	var font_styles = "";
	fonts.forEach(function(font) {
		var font_name = get_font_name(font);
	...
	// ignored /home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
	...
	frappe.ui.form.ControlComment = frappe.ui.form.ControlTextEditor.extend({
		...
		get_toolbar_options: function get_toolbar_options() {
			var direction = frappe.utils.is_rtl() ? 'rtl' : 'ltr';
			var align = frappe.utils.is_rtl() ? 'right' : 'left';
			return [
				['bold', 'italic', 'underline'],
				['blockquote', 'code-block'],
				['link', 'image'],
				...
				if(this.frm) {
					...
					return frappe.run_serially([
						...
						function () {
							...
							return this$1.frm.script_manager.trigger(this$1.grid.df.fieldname + "_remove",
								this$1.doc.doctype, this$1.doc.name);
						},
						function () {
							this$1.frm.dirty();
		...
		setup_check() {
			...
			this.remove_rows_button.on('click', function() {
				...
				me.get_selected_children().forEach(function (doc) {
					...
					tasks.push(function () { return frappe.timeout(0); });
				});
