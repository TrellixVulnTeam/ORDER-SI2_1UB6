	...
	*/
	...
	frappe.ui.form.MultiSelectDialog = Class.extend({
		...
		get_results: function() {
			...
			var filter_fields = [me.date_field];
			if($.isArray(this.setters)) {
				for (var i = 0, list = this.setters; i < list.length; i += 1) {
					var df = list[i];
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FilePreview.vue";
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/TreeNode.vue";
	...
	__vue_render__$2._withStripped = true;
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FileBrowser.vue";
	...
	__vue_render__$3._withStripped = true;
	  ...
	  var __vue_inject_styles__$3 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-76fa0af4_0", { source: "\n.file-web-link .input-group {\n\tmargin-top: 10px;\n}\n", map: {"version":3,"sources":["/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/WebLink.vue"],"names":[],"mappings":";AAgCA;CACA,gBAAA;AACA","file":"WebLink.vue","sourcesContent":["<template>\n\t<div class=\"file-web-link margin-bottom\">\n\t\t<a href class=\"text-muted text-medium\"\n\t\t\t@click.prevent=\"$emit('hide-web-link')\"\n\t\t>\n\t\t\t{{ __('← Back to upload files') }}\n\t\t</a>\n\t\t<div class=\"input-group\">\n\t\t\t<div class=\"input-group-addon\">\n\t\t\t\t<span class=\"text-muted text-medium\">{{ __('Web Link') }}</span>\n\t\t\t</div>\n\t\t\t<input\n\t\t\t\ttype=\"text\"\n\t\t\t\tclass=\"form-control\"\n\t\t\t\t:placeholder=\"__('Attach a web link')\"\n\t\t\t\tv-model=\"url\"\n\t\t\t>\n\t\t</div>\n\t</div>\n</template>\n<script>\nexport default {\n\tname: 'WebLink',\n\tdata() {\n\t\treturn {\n\t\t\turl: '',\n\t\t}\n\t}\n}\n</script>\n\n<style>\n.file-web-link .input-group {\n\tmargin-top: 10px;\n}\n</style>\n"]}, media: undefined });
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/WebLink.vue";
	...
	__vue_render__$4._withStripped = true;
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/file_uploader/FileUploader.vue";
	...
	__vue_render__$5._withStripped = true;
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Popover.vue";
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Dropdown.vue";
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/DeskModuleBox.vue";
	...
	__vue_render__$8._withStripped = true;
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/DeskSection.vue";
	...
	__vue_render__$9._withStripped = true;
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/ubuntu/frappe-bench/apps/frappe/frappe/public/js/frappe/views/components/Desktop.vue";
	...
	frappe.ui.Notifications = class Notifications {
		...
		get_dropdown_item_html(field) {
			var doc_link = frappe.utils.get_form_link(
				field.document_type,
				field.document_name
			);
	...
	frappe.views.CommunicationComposer = Class.extend({
		...
		setup_earlier_reply: async function() {
			...
			if (!signature) {
				var res = await this.get_default_outgoing_email_account_signature();
			...
			if (this.is_a_reply || this.forward) {
				...
				var fwd = this.forward ? "<b>Forwarded Message</b><br>" : "";
